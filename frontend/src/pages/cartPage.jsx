                      ...
                      <div className="flex justify-between sm:grid sm:grid-cols-2">
                        <div className="pr-6">
                          <h3 className="text-sm">
                            <a href={cartItem.href} className="font-medium text-gray-700 hover:text-gray-800">
                              {cartItem.name}
                            </a>
                          </h3>
                          <p className="mt-1 text-sm text-gray-500">{cartItem.color}</p>
                          {cartItem.size ? <p className="mt-1 text-sm text-gray-500">{cartItem.size}</p> : null}
                        </div>

                        <p className="text-right text-sm font-medium text-gray-900">{cartItem.price}</p>
                      </div>
